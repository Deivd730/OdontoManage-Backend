...
final class Version20260224145704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dentist (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, available_days INT DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, box_id INT DEFAULT NULL, pathology_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_6C8FB839E7927C74 (email), UNIQUE INDEX UNIQ_6C8FB839CE86795D (pathology_id), INDEX IDX_6C8FB839D8177B3F (box_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE treatment (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, minutes INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql("INSERT INTO dentist (id, email, roles, password, first_name, last_name, available_days, phone, updated_at, box_id, pathology_id) VALUES
            (1, 'ana.garcia@clinic.local', '[\"ROLE_DENTIST\"]', '\$2y\$13\$4S2gNqEVlx7k9JrLmP5Q.u0W3X6Y9Z2B5C8D1E4F7G0H3K6N9Q', 'Ana', 'Garcia', 1, '600111222', '2026-02-24 09:00:00', NULL, NULL),
            (2, 'luis.martin@clinic.local', '[\"ROLE_DENTIST\"]', '\$2y\$13\$4S2gNqEVlx7k9JrLmP5Q.u0W3X6Y9Z2B5C8D1E4F7G0H3K6N9Q', 'Luis', 'Martin', 2, '600333444', '2026-02-24 09:05:00', NULL, NULL),
            (3, 'marta.suarez@clinic.local', '[\"ROLE_DENTIST\"]', '\$2y\$13\$4S2gNqEVlx7k9JrLmP5Q.u0W3X6Y9Z2B5C8D1E4F7G0H3K6N9Q', 'Marta', 'Suarez', 3, '600555666', '2026-02-24 09:10:00', NULL, NULL),
            (4, 'pedro.alvarez@clinic.local', '[\"ROLE_DENTIST\"]', '\$2y\$13\$4S2gNqEVlx7k9JrLmP5Q.u0W3X6Y9Z2B5C8D1E4F7G0H3K6N9Q', 'Pedro', 'Alvarez', 4, '600777888', '2026-02-24 09:15:00', NULL, NULL),
            (5, 'laura.gomez@clinic.local', '[\"ROLE_DENTIST\"]', '\$2y\$13\$4S2gNqEVlx7k9JrLmP5Q.u0W3X6Y9Z2B5C8D1E4F7G0H3K6N9Q', 'Laura', 'Gomez', 5, '600999000', '2026-02-24 09:20:00', NULL, NULL)
        ");

        $this->addSql("INSERT INTO treatment (id, name, description, minutes) VALUES
        ...
        $this->addSql("INSERT INTO patient (id, first_name, last_name, national_id, social_security_number, phone, email, address, billing_data, health_status, family_history, lifestyle_habits, medication_allergies, registration_date, profile_image_name, updated_at) VALUES
            (1, 'Carlos', 'Lopez', '12345678A', 'SSN-001', '700111222', 'carlos.lopez@mail.local', 'Calle Mayor 1', 'NIF:12345678A', 'Sin patologias', 'Sin antecedentes', 'No fumador', 'Ninguna', '2026-02-24 10:00:00', 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAwMCAO2pQxkAAAAASUVORK5CYII=', '2026-02-24 10:00:00'),
            (2, 'Elena', 'Perez', '23456789B', 'SSN-002', '700333444', 'elena.perez@mail.local', 'Avenida Sol 5', 'NIF:23456789B', 'Alergia leve', 'Diabetes', 'Sedentario', 'Penicilina', '2026-02-24 10:05:00', 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAwMCAO2pQxkAAAAASUVORK5CYII=', '2026-02-24 10:05:00'),
            ...
            (4, 'Lucia', 'Ruiz', '45678901D', 'SSN-004', '700777888', 'lucia.ruiz@mail.local', 'Plaza Norte 7', 'NIF:45678901D', 'Asma controlada', 'Asma', 'No fumador', 'Ibuprofeno', '2026-02-24 10:15:00', 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAwMCAO2pQxkAAAAASUVORK5CYII=', '2026-02-24 10:15:00'),
            (5, 'Mario', 'Vega', '56789012E', 'SSN-005', '700999000', 'mario.vega@mail.local', 'Calle Sur 9', 'NIF:56789012E', 'Sin patologias', 'Sin antecedentes', 'Fumador', 'Ninguna', '2026-02-24 10:20:00', 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAwMCAO2pQxkAAAAASUVORK5CYII=', '2026-02-24 10:20:00'),
